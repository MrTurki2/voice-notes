  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-2">
              🎯 تجربة رقم 2: أفضل الممارسات
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              تقطيع ذكي تلقائي (VAD) + تحسينات الصوت + دقة أعلى
            </p>
          </div>
          <div className="flex gap-2">
            <Link href="/live" className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors">
              📱 تجربة 1
            </Link>
        ...
        {/* Info Box */}
        <div className="bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 rounded-lg p-4 mb-6 border-l-4 border-blue-500">
          <h3 className="font-bold text-gray-800 dark:text-white mb-2">✨ المميزات:</h3>
          <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
            <li>🎤 <strong>تقطيع تلقائي:</strong> كل 25 ثانية (أفضل من 30 ثانية)</li>
            <li>🔊 <strong>تحسين الصوت:</strong> noise suppression + echo cancellation</li>
            <li>📊 <strong>مؤشر الدقة:</strong> حسب مدة التسجيل</li>
            <li>💾 <strong>تصدير:</strong> حفظ كملف نصي</li>
          </ul>
        </div>
          ...
          <div className="flex flex-col items-center">
            {!isRecording ? (
              <button
                ...
                className="w-36 h-36 rounded-full font-bold text-white shadow-2xl transition-all transform hover:scale-110 bg-gradient-to-br from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700"
              >
                <div className="flex flex-col items-center">
          ...
          <div className="space-y-4 max-h-[600px] overflow-y-auto">
            {segments.length === 0 ? (
              ...
              segments.map((segment) => (
                <div
                  key={segment.id}
                  className="p-5 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-gray-700 dark:to-gray-600 rounded-lg border-r-4 border-emerald-500 hover:shadow-lg transition-all"
                >
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs px-2 py-1 rounded-full bg-emerald-200 dark:bg-emerald-700 text-emerald-800 dark:text-emerald-200">
